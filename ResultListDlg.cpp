...
CResultListDlg::CResultListDlg(CLinterPlugin* Parent)
  ...
  , mFormatButton(IDC_BUTTON3, IDC_FORMAT_BITMAP, IDB_WARNING_ENABLED, IDB_WARNING_DISABLED)
  , mIgnoreButton(IDC_BUTTON4, IDC_IGNORED_BITMAP, IDB_WARNING_ENABLED, IDB_WARNING_DISABLED)
  , mDebugButton(IDC_BUTTON5, IDC_DEBUG_BITMAP, IDB_WARNING_ENABLED, IDB_WARNING_DISABLED)
  , mFormatVisible(TRUE)
  , mInfoVisible(TRUE)
  , mParent(Parent)
{
